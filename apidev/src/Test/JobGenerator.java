	...
	public void readFile() {
	        ...
	        while( rows.hasNext() ) {
		            ...
		            while(cells.hasNext()){
		            	  ...
		            	  switch(count){
			            	  case 0:
			            		  int someNo = (int) cell.getNumericCellValue();
			            		  jobIdList.add(someNo+"");
			            		  break;
			            	  case 1:
			            		  jobProcessingTimes.add((long) cell.getNumericCellValue()*secToMillis);
			            		  break;
			            	  case 2:
...
//			            		  System.out.println("hello");
			            		  break;
			            	  case 6:
			            		  jobDueDates.add(cell.getNumericCellValue()*secToMillis);
